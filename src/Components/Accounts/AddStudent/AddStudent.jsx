...
import { callAPI, dateFormatter } from '../../../Helper';
...
const AddStudent = () => {
  ...
  const onSubmit = (data) => {
    ...
    let addStudentData = {
      ...
      info: {
        ...
        grade: selectValue.grade
      }
    };

    console.log('selectValue.', selectValue);
    delete addStudentData.createdat;
    delete addStudentData.schoolname;
    setLoader(true);
    callAPI(
      'post',
      ...
      .then((res) => {
        console.log('selectValue.schoolName', selectValue);
        callAPI(
          'post',
  ...
  const downloadTemplate = (e) => {
    e.preventDefault();
    window.open(Constants.STUDENT_BULK_DOWNLOAD, '_blank');
  };

  const S3_BUCKET = 'bulk-student-upload';
  // const REGION = 'Global';
          ...
          <div className="add-teacher-container">
            ...
            {switchTab ? (
              <>
                ...
                <div className="add-teacher-main-form">
                  <div className="add-teacher-options">
                    <a onClick={() => setSwitchTab(true)} id="add-teacher-options-active">
                      Student details
                    </a>
                    <a onClick={() => setSwitchTab(false)}>Bulk upload</a>
                  </div>
                            ...
                            <div className="internal right">
                              ...
                              <div className="column">
                                <div className="input-box">
                                  ...
                                  <div className="select-box">
                                    <SelectInputField
                                      options={Constants.GRADE}
                                      selectData={(dataValue) =>
                                        setSelectValue({ ...selectValue, grade: dataValue })
                                      }
                                      select={selectValue.grade}
                              ...
                              <div className="select-box">
                                <SelectInputField
                                  ...
                                  selectData={(dataValue) =>
                                    setSelectValue({ ...selectValue, sex: dataValue })
                                  }
                                  select={selectValue.sex}
                                  selectError={selectError}
                                />
                              </div>
                            </div> */}
                              ...
                              <div className="select-box">
                                <SelectInputField
                                  options={Constants.ADD_SCHOOL.SCHOOL_DETAILS.SCHOOL_TYPE_DATA}
                                  selectData={(dataValue) =>
                                    setSelectValue({ ...selectValue, language: dataValue })
                                  }
                                  select={selectValue.language}
                                  selectError={selectError}
                                />
                              </div>
                            </div> */}
              ...
              <>
                ...
                <div className="add-teacher-main-form">
                  <div className="add-teacher-options">
                    <a onClick={() => setSwitchTab(true)}>Student details</a>
                    <a onClick={() => setSwitchTab(false)} id="add-teacher-options-active">
                      Bulk upload
                    </a>
                  </div>
                  <div className="add-teacher-main-form">
